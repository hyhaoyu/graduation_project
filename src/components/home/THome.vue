  ...
  <div>
    <b-navbar toggleable="lg" type="dark" variant="info">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          <b-nav-item href="#" :to="{name:'hello'}">首页</b-nav-item>
          <b-nav-item href="#" :to="{name:'myTeachingCourse'}">我的课程</b-nav-item>
        </b-navbar-nav>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-form>
            ...
            <b-button size="sm" class="my-2 my-sm-0" type="submit"
                      :to="{name:'myTeachingCourse', query:{courseName}}">搜索</b-button>
          </b-nav-form>
